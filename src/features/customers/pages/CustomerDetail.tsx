...
export const CustomerDetail: React.FC = () => {
  ...
  // Mock outstanding balance (will fetch real ledger totals in ledger/sales phases)
  ...
  const getWhatsAppLink = (): string => {
    ...
    // Standard Indian prefix (+91)
    const formattedPhone = customer.phone.startsWith('91') || customer.phone.length > 10
      ? customer.phone 
      : `91${customer.phone}`;
      
    const shopName = shop?.shop_name || 'our store';
    const msg = `Dear ${customer.name}, this is a friendly reminder from ${shopName} that your outstanding credit balance in our ledger is ₹${outstandingCredit}. Please clear it at your earliest convenience. Thank you!`;
          ...
          <div style={styles.grid}>
            ...
            <div style={styles.notesSection} className="glass-panel">
              <div style={styles.actionsHeader}>
                <h3 style={styles.notesTitle}>Ledger Notes & Information</h3>
              ...
              <div style={{ ...styles.metaTextGroup, marginTop: '16px' }}>
              ...
              <div style={styles.infoBanner}>
                <Notebook size={16} style={{ color: 'var(--primary)' }} />
                <span style={{ fontSize: '0.75rem', color: 'var(--text-secondary)' }}>
                  Credit transactions, ledger logs, and digital invoices for this customer will be integrated in subsequent phases.
                </span>
              </div>
            </div>
          </div>
