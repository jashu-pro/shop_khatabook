...
export const shopRegistrationSchema = z.object({
  ...
  owner_photo_url: z.string().optional().nullable(),
  owner_photo_path: z.string().optional().nullable(),

  shop_name: z.string().min(1, 'Shop name is required'),
  business_category: z.string().min(1, 'Please select a business category'),
  shop_logo_url: z.string().optional().nullable(),
  shop_logo_path: z.string().optional().nullable(),

  door_number: z.string().optional().nullable(),
